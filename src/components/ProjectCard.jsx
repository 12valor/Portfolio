...
// 1. Ensure you are 'destructuring' the props here
        ...
        <div className="canvas">
          ...
          <div id="card">
            <div className="card-content">
              {/* ... existing glare and lines ... */}
              
              {/* 2. CHANGE THIS: Use {title} instead of "Arduino" */}
              <p id="prompt" className="uppercase tracking-[0.3em] text-blue-500 font-bold">
                {title}
              </p>
              
              <div className="title">
                {/* 3. This splits the title to show the first word in big text */}
                {title.split(' ')[0]}<br />
                <span className="text-[10px] tracking-widest opacity-50">PROTOTYPE</span>
              </div>

              {/* ... existing glow elements ... */}

              <div className="subtitle">
                {/* 4. USE {description} HERE */}
                <p className="px-10 mb-6 text-[12px] leading-relaxed text-zinc-400 font-medium">
                  {description}
                </p>
                <div className="flex justify-center gap-3">
                  {tags.map(tag => (
                    <span key={tag} className="highlight text-[10px]">#{tag}</span>
                  ))}
                </div>
              </div>

              {/* ... existing particles and scan lines ... */}
            </div>
          </div>
        </div>
      </div>
...
// ... StyledWrapper CSS remains the same ...
